...
fix_musl_static_link_flags() {
  ...
  test_dir=$(mktemp -d "${TMPDIR:-/tmp}/busybox-musl-link.XXXXXX")
...
config_set CONFIG_INSMOD y
config_set CONFIG_RMMOD y
config_set CONFIG_LSMOD y
config_set CONFIG_MODPROBE y
config_set CONFIG_MODINFO y
config_set CONFIG_DEPMOD y
